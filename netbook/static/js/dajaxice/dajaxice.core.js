...
var Dajaxice = {
    ...
    get_progress: function(callback_function, argv, custom_settings){
        return Dajaxice.call('apps.books.get_progress', 'POST', callback_function, argv, custom_settings);
    },

    from_douban: function(callback_function, argv, custom_settings){
        return Dajaxice.call('apps.books.from_douban', 'POST', callback_function, argv, custom_settings);
    },

    from_douban_multi: function(callback_function, argv, custom_settings){
        return Dajaxice.call('apps.books.from_douban_multi', 'POST', callback_function, argv, custom_settings);
    }
